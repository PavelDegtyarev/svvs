    ...
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                jwt_1.JwtModule.register({
                    privateKey: environment_1.environment.jwt.secret,
                    signOptions: {
                        expiresIn: environment_1.environment.jwt.expiresIn,
                    }
                })
            ],
            providers: [auth_service_1.AuthService, jwt_strategy_1.JwtStrategy, password_service_1.PasswordService, auth_resolver_1.AuthResolver],
            exports: [
                // AuthService,
