...
var AuthResolver = function () {
    var _classDecorators = [(0, graphql_1.Resolver)('Auth')];
    ...
    var AuthResolver = _classThis = /** @class */ (function () {
        ...
        AuthResolver_1.prototype.login = function (signInPayload) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.login(signInPayload)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        AuthResolver_1.prototype.logout = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
    ...
    (function () {
        ...
        _login_decorators = [(0, graphql_1.Query)('login')];
        _logout_decorators = [(0, graphql_1.Query)('logout')];
